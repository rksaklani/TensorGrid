#!/usr/bin/env python
"""
Installs TensorGrid (fork of FiftyOne).

| Copyright 2017-2026, Voxel51, Inc. (original FiftyOne)
...
setup(
    ...
    description=(
        ...
        "datasets and computer vision models (derived from FiftyOne)"
    ),
    ...
    entry_points={
        "console_scripts": [
            "tg=tensorgrid.core.cli:main",
            "tensorgrid=tensorgrid.core.cli:main",
            "fiftyone=tensorgrid.core.cli:main",
        ]
    },
    ...
    extras_require={
        ...
        "multimodal": ["tensorgrid[multimodal-mcap]"],
    },
)
