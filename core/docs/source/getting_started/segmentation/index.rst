...
This step-by-step guide will walk you through a complete segmentation workflow using TensorGrid. You'll learn how to:

- Load and visualize segmentation datasets from TensorGrid's zoo and custom formats
...
1. **Loading Segmentation Datasets** - Learn how to load semantic and instance segmentation datasets from TensorGrid's zoo and from custom formats like COCO or segmentation masks
...
3. **Segment Anything 2 (SAM2) in TensorGrid** - Explore SAM 2's groundbreaking capabilities for image and video segmentation, including bounding boxes, keypoints, or zero prompts, and video mask propagation
...
This page is for those new to TensorGrid looking to get started with segmentation workflows! We will cover how to load, visualize, enrich, and evaluate segmentation datasets with TensorGrid. This tutorial is ideal for computer vision engineers and AI researchers working with instance and semantic segmentation tasks.
...
2. **Dataset Exploration** - Visualizing and understanding your segmentation data using TensorGrid's interactive interface
...
Click **Next** to start with the first step: Loading Segmentation Datasets in TensorGrid.
...
.. toctree::
   ...
   Segment Anything 2 in TensorGrid <03_sam2>
