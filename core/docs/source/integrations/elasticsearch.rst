...
using Elasticsearch + TensorGrid.

TensorGrid provides an API to create Elasticsearch indexes, upload vectors, and
...
Alternatively, you can permanently configure TensorGrid to use the Elasticsearch
...
by TensorGrid whenever a connection to Elasticsearch is made.
...
a TensorGrid dataset using the Elasticsearch backend.
