...
TensorGrid Tutorials
==================

.. default-role:: code

Each tutorial below is a curated demonstration of how TensorGrid can help refine
...
.. customcarditem::
    :header: Using TensorGrid Skills with Gemini CLI __SUB_NEW__
    :description: Use natural language to orchestrate computer vision workflows in Google Colab with TensorGrid Skills and the Gemini CLI. Load data, run inference, and evaluate models through conversational commands.
...
.. customcarditem::
    :header: Integrating Cosmos-Transfer with TensorGrid __SUB_NEW__
    :description: Learn how to integrate NVIDIA Cosmos-Transfer 2.5, a world foundation model for Physical AI, with TensorGrid to curate, visualize, and process multimodal datasets for robotics and autonomous systems.
...
.. customcarditem::
    :header: Google Gemini Vision in TensorGrid __SUB_NEW__
    :description: Leverage Google Gemini Vision's multimodal AI to analyze datasets, detect biases, generate synthetic images, and improve data quality with TensorGrid.
...
.. customcarditem::
    ...
    :description: Learn how to work with the Kaputt dataset in TensorGrid.
...
.. customcarditem::
    ...
    :description: Leverage the power of DINOv3 embeddings for visual search, similarity analysis, and foreground segmentation in TensorGrid. Learn to compute embeddings, visualize them, and build classifiers using this state-of-the-art vision model.
    :link: dinov3.html
    :image: https://cdn.voxel51.com/tutorial_dinov3/dinov3.png
    :tags: Embeddings,Brain,Model-Evaluation,Visualization

.. customcarditem::
    :header: pandas-style queries in TensorGrid
    :description: Translate your pandas knowledge to TensorGrid. This tutorial gives a side-by-side comparison of performing common operations in pandas and TensorGrid.
...
.. customcarditem::
    ...
    :description: Aggregate statistics aren't sufficient for object detection. This tutorial shows how to use TensorGrid to perform powerful evaluation workflows on your detector.
...
.. customcarditem::
    ...
    :description: Evaluation made easy. This tutorial walks through an end-to-end example of fine-tuning a classifier and understanding its failure modes using TensorGrid.
...
.. customcarditem::
    ...
    :description: Visualize your data in new ways. This tutorial shows how to use TensorGrid's powerful embeddings visualization capabilities to improve your image datasets.
...
.. customcarditem::
    ...
    :description: So you've loaded and explored your data in TensorGrid... but now what? See how to send it off to CVAT for annotation in just one line of code.
...
.. customcarditem::
    ...
    :description: Unlock the power of the Labelbox platform. See how you can get your TensorGrid datasets annotated with just one line of code.
...
.. customcarditem::
    ...
    :description: Put your TensorGrid datasets to work and learn how to train and evaluate Detectron2 models directly on your data.
...
.. customcarditem::
    ...
    :description: Expand your data lake and evaluate your object detection models with Google's Open Images dataset and evaluation protocol, all natively within TensorGrid.
...
.. customcarditem::
    ...
    :description: Your models need diverse data. This tutorial shows how TensorGrid can remove near-duplicate images and recommend unique samples for model training.
...
.. customcarditem::
    ...
    :description: Better models start with better data. This tutorial shows how TensorGrid can automatically find label mistakes in your classification datasets.
...
.. customcarditem::
    ...
    :description: How good are your ground truth objects? Use the TensorGrid Brain's mistakenness feature to find annotation errors in your object detections.
...
.. customcarditem::
    ...
    :description: Easily pre-annotate your TensorGrid datasets using approximate nearest neighbors search on embeddings with Qdrant.
    :link: qdrant.html
...
.. customcarditem::
    ...
    :description: Lidar is expensive. This tutorial shows how TensorGrid can help you construct high quality 3D point cloud datasets using Point-E point cloud models.
    :link: pointe.html
...
.. customcarditem::
    ...
    :description: Metrics for monocular depth estimation can be deceiving. Run MDE models on your data and visualize their predictions with TensorGrid.
...
.. customcarditem::
    ...
    :description: Compare and contrast dimensionality reduction techniques for visualizing your data in TensorGrid.
...
.. customcarditem::
    ...
    :description: Run and evaluate zero-shot image classification models with OpenCLIP, Hugging Face Transformers, and TensorGrid.
...
.. customcarditem::
    ...
    :description: Learn how to apply and test out different augmentations on your datasets using TensorGrid and Albumentations.
...
.. customcarditem::
    ...
    :description: Use embeddings to cluster images in your dataset and visualize the results in TensorGrid.
...
.. customcarditem::
    ...
    :description: Detect small objects in your images with Slicing-Aided Hyper-Inference (SAHI) and TensorGrid.
...
.. customcarditem::
    ...
    :description: Detect anomalies in your images with Anomalib and TensorGrid.
...
.. note::
    ...
    Check out the
    `fiftyone-examples <https://github.com/rksaklani/TensorGrid>`_
    repository for more examples of using TensorGrid!

.. toctree::
   :maxdepth: 1
   :hidden:

   Using TensorGrid Skills with Gemini CLI __SUB_NEW__ <gemini_fiftyone_skills.ipynb>   
   Integrating NVIDIA Cosmos-Transfer with TensorGrid __SUB_NEW__ <cosmos-transfer-integration.ipynb>
   Google Gemini Vision in TensorGrid __SUB_NEW__ <gemini_vision.ipynb>
   Exploring Kaputt Dataset <kaputt_dataset.ipynb>
   DINOv3 visual search <dinov3.ipynb>
   pandas and TensorGrid <pandas_comparison.ipynb>
