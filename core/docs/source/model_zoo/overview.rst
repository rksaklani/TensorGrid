...
The TensorGrid Model Zoo provides a powerful interface for downloading models
and applying them to your TensorGrid datasets.
...
:meth:`load_zoo_model() <tensorgrid.zoo.models.load_zoo_model>` and then
...
.. tabs::
  ...
  .. group-tab:: Logits
    ...
    :meth:`has_logits() <tensorgrid.core.models.Model.has_logits>`:
...
.. note::
    ...
    :meth:`apply_model() <tensorgrid.core.collections.SampleCollection.apply_model>`
    and :meth:`compute_embeddings() <tensorgrid.core.collections.SampleCollection.compute_embeddings>`!
