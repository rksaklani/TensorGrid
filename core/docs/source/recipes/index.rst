...
TensorGrid turbocharges your current workflows, transforming hours of scripting
into minutes so that you can focus on your models. Browse the recipes below to
see how you can leverage TensorGrid to enhance key parts of your machine learning
workflows.
...
.. customcarditem::
    ...
    :description: Learn how to efficiently load and work with TensorGrid datasets in PyTorch using TensorGridTorchDataset.
...
.. customcarditem::
    ...
    :description: Train a simple PyTorch model on the MNIST dataset using `TensorGridTorchDataset`, with train/validation/test splits managed in TensorGrid and a reusable training script.
...
.. customcarditem::
    ...
    :description: Improve training performance by preloading specific fields into memory using the `SimpleGetItem` wrapper class with `vectorize=True` in `TensorGridTorchDataset`.
...
.. customcarditem::
    ...
    :description: Create views to easily query and explore your datasets in TensorGrid.
...
.. customcarditem::
    ...
    :description: Automatically find and remove duplicate and near-duplicate images from your TensorGrid datasets.
...
.. customcarditem::
    ...
    :description: Check out some common workflows for finding and removing duplicate objects from your TensorGrid datasets.
...
.. customcarditem::
    ...
    :description: Add TensorGrid to your model training and analysis loop to visualize and analyze your classifier's predictions.
...
.. customcarditem::
    ...
    :description: Use TensorGrid to store your object detections and use the TensorGrid App to analyze them.
...
.. customcarditem::
    ...
    :description: Render labels on the samples in your TensorGrid Dataset with a single line of code.
...
.. customcarditem::
    ...
    :description: Use TensorGrid's powerful dataset import/export features to convert your datasets on disk between standard (or custom) formats.
...
.. customcarditem::
    ...
    :description: Easily merge datasets on disk or in-memory using TensorGrid; e.g., to add a new set of model predictions to a dataset.
...
.. customcarditem::
    ...
    :description: Write your own custom DatasetImporter and use it to import datasets in your custom format into TensorGrid.
...
.. customcarditem::
    ...
    :description: Write your own custom DatasetExporter and use it to export a TensorGrid Dataset to disk in your custom format.
...
.. customcarditem::
    ...
    :description: Write your own custom SampleParser and use it to add samples in your custom format to a TensorGrid Dataset.
