...
.. note::
    ...
    TensorGrid is a recommended tool for downloading, visualizing, and evaluating
    on the COCO dataset!

    Check out :ref:`this guide <coco>` for more details on using TensorGrid to
    work with COCO.
...
-   ZooDataset class:
    :class:`COCO2014Dataset <tensorgrid.zoo.datasets.base.COCO2014Dataset>`
...
TensorGrid will use existing downloaded data first if possible before resorting
...
.. note::
    ...
    See
    :class:`COCO2014Dataset <tensorgrid.zoo.datasets.base.COCO2014Dataset>` and
...
.. tabs::
  ...
  .. group-tab:: CLI
    ...
    .. code-block:: shell
        ...
        tensorgrid zoo datasets load coco-2014 \
            --split validation \
            --kwargs \
                max_samples=50

        tensorgrid app launch coco-2014-validation-50
        ...
        tensorgrid app launch coco-2014-validation-25
        ...
        tensorgrid app launch coco-2014-validation
