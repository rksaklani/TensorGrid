...
-   ZooDataset classes:
    ...
    -   :class:`VOC2012Dataset <tensorgrid.zoo.datasets.tf.VOC2012Dataset>` (TF backend)
    -   :class:`VOC2012Dataset <tensorgrid.zoo.datasets.torch.VOC2012Dataset>` (Torch backend)
...
.. tabs::
  ...
  .. group-tab:: CLI
    ...
    .. code-block:: shell
        ...
        tensorgrid zoo datasets load voc-2012 --split validation

        tensorgrid app launch voc-2012-validation
