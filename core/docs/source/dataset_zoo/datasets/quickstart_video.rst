...
-   ZooDataset class:
    :class:`QuickstartVideoDataset <tensorgrid.zoo.datasets.base.QuickstartVideoDataset>`
...
.. tabs::
  ...
  .. group-tab:: CLI
    ...
    .. code-block:: shell
        ...
        tensorgrid zoo datasets load quickstart-video

        tensorgrid app launch quickstart-video
