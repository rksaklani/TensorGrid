...
-   ZooDataset class:
    :class:`Kinetics600Dataset <tensorgrid.zoo.datasets.base.Kinetics600Dataset>`
...
.. tabs::
  ...
  .. group-tab:: CLI
    ...
    .. code-block:: shell
        ...
        tensorgrid zoo datasets load kinetics-600 \
            --split validation \
            --kwargs max_samples=10

        tensorgrid app launch kinetics-600-validation-10
        ...
        tensorgrid zoo datasets load kinetics-600 --split validation

        tensorgrid app launch kinetics-600-validation
