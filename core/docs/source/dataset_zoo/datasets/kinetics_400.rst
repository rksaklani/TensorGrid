...
-   ZooDataset class:
    :class:`Kinetics400Dataset <tensorgrid.zoo.datasets.base.Kinetics400Dataset>`
...
.. tabs::
  ...
  .. group-tab:: CLI
    ...
    .. code-block:: shell
        ...
        tensorgrid zoo datasets load kinetics-400 \
            --split validation \
            --kwargs max_samples=10

        tensorgrid app launch kinetics-400-validation-10
        ...
        tensorgrid zoo datasets load kinetics-400 --split validation

        tensorgrid app launch kinetics-400-validation
