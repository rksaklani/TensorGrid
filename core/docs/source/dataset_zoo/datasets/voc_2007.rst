...
-   ZooDataset classes:
    ...
    -   :class:`VOC2007Dataset <tensorgrid.zoo.datasets.tf.VOC2007Dataset>` (TF backend)
    -   :class:`VOC2007Dataset <tensorgrid.zoo.datasets.torch.VOC2007Dataset>` (Torch backend)
...
.. tabs::
  ...
  .. group-tab:: CLI
    ...
    .. code-block:: shell
        ...
        tensorgrid zoo datasets load voc-2007 --split validation

        tensorgrid app launch voc-2007-validation
