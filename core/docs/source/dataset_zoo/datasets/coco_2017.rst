...
-   ZooDataset class:
    :class:`COCO2017Dataset <tensorgrid.zoo.datasets.base.COCO2017Dataset>`
...
.. tabs::
  ...
  .. group-tab:: CLI
    ...
    .. code-block:: shell
        ...
        tensorgrid zoo datasets load coco-2017 \
            --split validation \
            --kwargs \
                max_samples=50

        tensorgrid app launch coco-2017-validation-50
        ...
        tensorgrid app launch coco-2017-validation-25
        ...
        tensorgrid app launch coco-2017-validation
