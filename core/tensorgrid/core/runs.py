...
from tensorgrid.core.config import Config, Configurable
from tensorgrid.core.odm import patch_runs
from tensorgrid.core.odm.runs import RunDocument
...
class BaseRunConfig(Config):
    ...
    def base_config_cls(type):
        ...
        import tensorgrid.utils.eval as foue
