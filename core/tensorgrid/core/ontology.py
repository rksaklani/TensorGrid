...
import tensorgrid.core.annotation.constants as foac
import tensorgrid.core.utils as fou
from tensorgrid.core.annotation.attributes import (
    AttributeSpec,
    attr_insert_to_dict,
)
from tensorgrid.core.annotation.nodes import Node
from tensorgrid.core.odm.ontology import OntologyDocument, OntologyType
...
class AnnotationOntology(Ontology):
    ...
    def _validate(self) -> None:
        ...
        from tensorgrid.core.ontology_validation import (
...
class Taxonomy(Ontology):
    ...
    def _validate(self) -> None:
        ...
        from tensorgrid.core.ontology_validation import validate_taxonomy
...
def _find_label_schema_refs_by_ontology(
    ...
    Returns:
        ...
        the ontology.
    """
    from tensorgrid.core.odm.dataset import DatasetDocument
...
def delete_ontology(name: str, force: bool = False) -> None:
    ...
    from tensorgrid.core.annotation import inline_applied_ontology
    from tensorgrid.core.odm.dataset import DatasetDocument
