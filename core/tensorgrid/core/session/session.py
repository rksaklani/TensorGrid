...
import tensorgrid.core.odm.dataset as food
from tensorgrid.core.odm.workspace import default_workspace_factory, Space
import tensorgrid.constants as focn
import tensorgrid.core.dataset as fod
from tensorgrid.core.config import AppConfig
import tensorgrid.core.context as focx
import tensorgrid.core.plots as fop
import tensorgrid.core.service as fos
from tensorgrid.core.state import build_color_scheme, StateDescription
import tensorgrid.core.utils as fou
import tensorgrid.core.view as fov

import tensorgrid.core.session.client as fosc
from tensorgrid.core.session.constants import (
...
from tensorgrid.core.session.events import (
    CaptureNotebookCell,
    CloseSession,
...
import tensorgrid.core.session.notebooks as fosn
...
📖  TensorGrid docs          See README in your install directory
🚀  Quick start              ./scripts/start-tensorgrid.sh
"""
...
def _normalize_selected_samples(
    ...
    from tensorgrid.core.session.utils import normalize_selected_samples
