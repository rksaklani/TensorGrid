...
from tensorgrid.core.annotation import constants as _fac
...
from tensorgrid.core.ontology import AnnotationOntology, Taxonomy
...
def _validate_taxonomy_ref(ontology: AnnotationOntology) -> list[str]:
    ...
    from tensorgrid.core.ontology import load_ontology
