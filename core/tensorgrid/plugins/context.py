...
from tensorgrid.operators.decorators import plugins_cache
from tensorgrid.operators.operator import Operator
...
def _ensure_parent_modules(module_name, plugin_dir):
    ...
    This enables absolute imports like:
        from tensorgrid.plugins.orgs.myorg.myplugin.submodule import X
    """
