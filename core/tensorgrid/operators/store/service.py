...
from tensorgrid.operators.store.models import StoreDocument, KeyDocument
...
if TYPE_CHECKING:
    ...
    from tensorgrid.factory.repos.execution_store import ExecutionStoreRepo
...
class ExecutionStoreService(object):
    ...
    def __init__(
        ...
        from tensorgrid.factory.repo_factory import (
            RepositoryFactory,
            ExecutionStoreRepo,
        )
