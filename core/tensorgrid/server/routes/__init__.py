...
from tensorgrid.internal.features.registry import is_feature_enabled

from tensorgrid.operators.server import OperatorRoutes
...
if is_feature_enabled("VFF_MULTIMODAL"):
    from tensorgrid.multimodal.server import MultimodalRoutes
