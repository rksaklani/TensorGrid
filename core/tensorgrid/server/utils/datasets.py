...
from tensorgrid.server.utils.json.jsonpatch import apply as apply_jsonpatch
from tensorgrid.server.utils.json.serialization import deserialize
...
def sync_to_generated_dataset(
    ...
    *,
    ...
    """
    generated_dataset = get_dataset(generated_dataset_name)
    generated_sample = get_sample_from_dataset(
