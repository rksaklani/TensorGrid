...
from tensorgrid.server.utils.json.jsonpatch.exceptions import RootDeleteError
from tensorgrid.server.utils.json.jsonpatch.methods import (
    add,
    copy,
    move,
    remove,
...
from tensorgrid.server.utils.json.jsonpatch.patch import (
    Patch,
    Operation,
    Add,
    Copy,
