import { Operator, OperatorConfig, types } from "@tensorgrid/operators";
import type { ExecutionContext } from "@tensorgrid/operators/src/operators";
import type { Property } from "@tensorgrid/operators/src/types";
