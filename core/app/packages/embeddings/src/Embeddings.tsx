import { Selector, useTheme } from "@tensorgrid/components";
import { OperatorPlacements, types } from "@tensorgrid/operators";
import { usePanelStatePartial, useSetPanelCloseEffect } from "@tensorgrid/spaces";
import { constants, useExternalLink } from "@tensorgrid/utilities";
import {
  Add,
  CenterFocusWeak,
  Close,
