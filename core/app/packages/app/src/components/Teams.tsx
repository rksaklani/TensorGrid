...
import { Button, ExternalLink, useTheme } from "@tensorgrid/components";
...
export default function Teams({
  ...
  const handleExplore = useCallback(() => {
    ...
    setShowPopover(false);
    window.open(
      "https://voxel51.com/why-upgrade?utm_source=TensorGridApp",
      "_blank",
    );
  }, [markTooltipSeen]);
  ...
  return (
    <>
      <ButtonContainer $bgColor={mode === "light" ? "transparent" : bgColor}>
        <StyledExternalLink href="https://voxel51.com/why-upgrade?utm_source=TensorGridApp">
        ...
        >
          ...
          >
            ...
            <PopoverBody variant="body2">
              With TensorGrid Enterprise you can connect to your data lake,
