...
import { ErrorBoundary, ThemeProvider } from "@tensorgrid/components";
import {
  GatedDynamicImports,
  type GatedDynamicImport,
} from "@tensorgrid/core/src/components/GatedDynamicImports";
import { FeatureFlag } from "@tensorgrid/feature-flags";
import { BeforeScreenshotContext, screenshotCallbacks } from "@tensorgrid/state";
...
const GATED_DYNAMIC_IMPORTS: GatedDynamicImport[] = [
  {
    ...
    registerModule: () => import("@tensorgrid/multimodal/inject"),
  },
];
