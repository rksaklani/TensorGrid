...
export const mapStyle = atom<string>({
  key: "@tensorgrid/map/state.mapStyle",
  default: defaultMapStyle,
  effects: [
    getBrowserStorageEffectForKey("@tensorgrid/map/state.style", {
      sessionStorage: true,
      map: (newValue: string) =>
