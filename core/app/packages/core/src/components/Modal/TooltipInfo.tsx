import { IconButton, Tooltip } from "@tensorgrid/components";
import * as fos from "@tensorgrid/state";
import { ModalMode, useModalMode } from "@tensorgrid/state";
import { isHoveringAnyLabelWithInstanceConfig } from "@tensorgrid/state/src/jotai";
