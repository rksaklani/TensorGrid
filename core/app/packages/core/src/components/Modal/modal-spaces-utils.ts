import { PluginComponentRegistration } from "@tensorgrid/plugins";
import { SpaceNodeJSON, usePanels } from "@tensorgrid/spaces";
import { panelsCompareFn } from "@tensorgrid/spaces/src/utils/sort";
