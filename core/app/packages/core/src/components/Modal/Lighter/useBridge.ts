...
import type { DetectionLabel } from "@tensorgrid/looker";
...
/**
 * Hook that bridges TensorGrid state management system with Lighter.
 *
 * This is two-way:
 * 1. We listen to certain events from "TensorGrid state" world and react to them, or
 * 2. We trigger certain events into "TensorGrid state" world based on user interactions in Lighter.
 */
