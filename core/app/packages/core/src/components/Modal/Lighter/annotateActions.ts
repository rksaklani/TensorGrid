/**
 * The looker package (@tensorgrid/looker) defines the Control/ControlMap shape and
...
import {
  ...
  resetZoom,
  selectSample,
} from "@tensorgrid/looker/src/shared/actions";
import type {
  BaseState,
  Control,
  ControlMap,
} from "@tensorgrid/looker/src/state";
