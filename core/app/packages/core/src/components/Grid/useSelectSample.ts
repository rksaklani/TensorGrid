import type { ThumbnailSelectionDetail } from "@tensorgrid/looker/src/selection";
import type { Sample } from "@tensorgrid/state";
import { selectedSampleObjects, selectedSamples } from "@tensorgrid/state";
