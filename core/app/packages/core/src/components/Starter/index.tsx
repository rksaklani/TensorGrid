import { CodeTabs, Loading, scrollable } from "@tensorgrid/components";
import { OperatorCore, useOperators } from "@tensorgrid/operators";
import {
  useOperatorBrowser,
  useOperatorExecutor,
  usePromptOperatorInput,
} from "@tensorgrid/operators/src/state";
import { datasetName as datasetNameAtom } from "@tensorgrid/state";
import {
  Button,
  ButtonProps,
  Divider,
