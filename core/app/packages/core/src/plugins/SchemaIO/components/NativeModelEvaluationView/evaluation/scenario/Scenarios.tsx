...
import { Plot } from "@tensorgrid/components/src/components/Plot";
import { usePanelEvent } from "@tensorgrid/operators";
import { usePanelId, usePanelStatePartial } from "@tensorgrid/spaces";
import { formatValueAsNumber, isNullish } from "@tensorgrid/utilities";
import {
  Autorenew,
  DragHandle,
  InsertChartOutlined,
