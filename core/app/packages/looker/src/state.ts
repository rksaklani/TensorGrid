...
import { BufferManager } from "@tensorgrid/utilities";
import { ImaVidFramesController } from "./lookers/imavid/controller";
import { Overlay } from "./overlays/base";

import { AppError, COLOR_BY, Schema, Stage } from "@tensorgrid/utilities";
...
export interface ImaVidState extends BaseState {
   ...
   * @see [Configuring TensorGrid](https://docs.voxel51.com/user_guide/config.html#configuring-the-app)
   */
