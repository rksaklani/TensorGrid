import type { SampleRendererProps } from "@tensorgrid/plugins";
import type { Track } from "@tensorgrid/playback";
import type { TemporalTagCreatePayload } from "@tensorgrid/playback";
