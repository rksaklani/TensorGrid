...
vi.mock(
  "@tensorgrid/core/src/components/Modal/Sidebar/Annotate/useAnnotationContextManager",
  () => ({ useAnnotationContextManager: vi.fn() }),
);

vi.mock("@tensorgrid/state", () => ({
...
import { useModalModeController } from "@tensorgrid/state";
