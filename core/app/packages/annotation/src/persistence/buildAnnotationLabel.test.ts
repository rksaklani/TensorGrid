...
// both the SUT and the test import from "@tensorgrid/lighter", and vitest
...
vi.mock("@tensorgrid/looker", () => ({}));
vi.mock("@tensorgrid/looker/src/overlays/classifications", () => ({}));
vi.mock("@tensorgrid/looker/src/overlays/polyline", () => ({}));
vi.mock("@tensorgrid/looker/src/state", () => ({ BoundingBox: undefined }));

const mockHasValidBounds = vi.fn().mockReturnValue(true);
vi.mock("@tensorgrid/utilities", () => ({
