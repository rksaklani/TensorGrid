...
import { getLabelColor } from "@tensorgrid/looker/src/overlays/util";
import type { ColorSchemeInput } from "@tensorgrid/relay";
import { COLOR_BY, getColor } from "@tensorgrid/utilities";
...
/**
 * Maps Lighter / Annotation overlay information to a color using TensorGrid's color scheme system.
 *
