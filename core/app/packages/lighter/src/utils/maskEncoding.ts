 ...
 * that TensorGrid stores in the database.
 *
 * Pipeline: canvas → uint8 mask → numpy .npy → zlib deflate → base64
 */

/**
 * Encodes a mask editing canvas into a base64 string matching TensorGrid's
 * stored mask format.
 *
...
/**
 * Encodes a raw uint8 mask array into a base64 string matching TensorGrid's
 * stored mask format.
 *
